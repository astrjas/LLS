...
####################################################################
def gsolve(nbl,nant,vdata,varr,varrcln,antlist,corr,itstr,refant,case,tba1,tba2,tbt,tbspw):#ainfo
    #gst0=time.time()
    plt.clf()
    theta_r_dict={}
    theta_m_dict={}
...
#antinfo,
xx=antfunc(dfile=datams1,it=it,pol=pol,date=date,case='ext')
#antinfo_clean,
xx_clean=antfunc(dfile=datams_cm,it=it,pol=pol,date=date,case='cln')
print("XX",xx.shape)
...
gsolve(nbl=nbl,nant=nant,vdata=tbData,varr=xx,varrcln=xx_clean,antlist=antlist,corr=corr,itstr=itstr,refant=refant,case='all',tba1=tba1,tba2=tba2,tbt=tbt,tbspw=tbspw)#ainfo=antinfo
...
xx1=antfunc(dfile=dvis,it=it,pol=pol,date=date,case='raw')
